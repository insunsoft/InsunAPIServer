...
CREATE TABLE `insun_ucenter_login` (
  ...
  `source` tinyint(2) DEFAULT '2' COMMENT '用户注册来源(0->iPhone, 1->iPad, 2->Android, 3->微信, 4->H5, 5->网站)',
  `social_source` tinyint(2) DEFAULT '0' COMMENT '第三方登录来源(0->手机, 1->微信, 2->QQ)',
