...
var z=gz$gwx_2()
var tM=_n('view')
var eN=_mz(z,'scroll-view',['scrollY',-1,'class',0],[],e,s,gg)
var bO=_mz(z,'image',['class',1,'mode',1,'src',2],[],e,s,gg)
_(eN,bO)
var oP=_n('view')
...
var z=gz$gwx_3()
var oR=_n('view')
var fS=_mz(z,'scroll-view',['scrollY',-1,'class',0],[],e,s,gg)
var cT=_n('view')
...
_(cT,oX)
_(fS,cT)
var aZ=_mz(z,'swiper',['autoplay',8,'circular',1,'class',2,'duration',3,'indicatorDots',4,'interval',5],[],e,s,gg)
var t1=_v()
_(aZ,t1)
...
var c8=_v()
_(f7,c8)
if(_oz(z,18,o4,b3,gg)){c8.wxVkey=1
var o0=_mz(z,'image',['mode',19,'src',1],[],o4,b3,gg)
_(c8,o0)
}
var h9=_v()
_(f7,h9)
if(_oz(z,21,o4,b3,gg)){h9.wxVkey=1
var cAB=_mz(z,'video',['autoplay',-1,'loop',-1,'controls',22,'muted',1,'objectFit',2,'showPlayBtn',3,'src',4],[],o4,b3,gg)
_(h9,cAB)
}
c8.wxXCkey=1
h9.wxXCkey=1
...
var xIB=_v()
_(bGB,xIB)
if(_oz(z,32,eFB,tEB,gg)){xIB.wxVkey=1
var oJB=_n('view')
_rz(z,oJB,'class',33,eFB,tEB,gg)
var fKB=_n('view')
_rz(z,fKB,'class',34,eFB,tEB,gg)
var cLB=_v()
_(fKB,cLB)
if(_oz(z,35,eFB,tEB,gg)){cLB.wxVkey=1
var hMB=_n('view')
_rz(z,hMB,'class',36,eFB,tEB,gg)
var oNB=_v()
_(hMB,oNB)
if(_oz(z,37,eFB,tEB,gg)){oNB.wxVkey=1
var cOB=_oz(z,38,eFB,tEB,gg)
_(oNB,cOB)
}
oNB.wxXCkey=1
_(cLB,hMB)
...
lCB.wxXCkey=2
_2z(z,30,aDB,e,s,gg,lCB,'item','index','index')
_(fS,oBB)
var aRB=_n('view')
...
var o2B=_mz(z,'image',['mode',50,'src',1],[],e,s,gg)
_(h1B,o2B)
var c3B=_n('view')
_rz(z,c3B,'class',52,e,s,gg)
var o4B=_n('view')
_rz(z,o4B,'class',53,e,s,gg)
var l5B=_oz(z,54,e,s,gg)
_(o4B,l5B)
_(c3B,o4B)
var a6B=_n('view')
var t7B=_n('view')
...
var hEC=_oz(z,63,e,s,gg)
_(cDC,hEC)
_(fCC,cDC)
_(oBC,fCC)
var oFC=_n('view')
_rz(z,oFC,'class',64,e,s,gg)
var cGC=_mz(z,'image',['mode',65,'src',1],[],e,s,gg)
_(oFC,cGC)
var oHC=_n('view')
_rz(z,oHC,'class',67,e,s,gg)
var lIC=_n('view')
_rz(z,lIC,'class',68,e,s,gg)
var aJC=_oz(z,69,e,s,gg)
_(lIC,aJC)
_(oHC,lIC)
var tKC=_n('view')
var eLC=_n('view')
...
_(tKC,eLC)
var oNC=_n('view')
_rz(z,oNC,'class',72,e,s,gg)
var xOC=_oz(z,73,e,s,gg)
_(oNC,xOC)
_(tKC,oNC)
_(oHC,tKC)
_(oFC,oHC)
...
var hSC=_mz(z,'home',['bind:__l',1,'vueId',1],[],e,s,gg)
_(cRC,hSC)
}
var oTC=_n('view')
_rz(z,oTC,'class',3,e,s,gg)
var cUC=_mz(z,'view',['bindtap',4,'class',1,'data-cur',2,'data-event-opts',3],[],e,s,gg)
var oVC=_n('view')
_rz(z,oVC,'class',8,e,s,gg)
var lWC=_n('image')
_rz(z,lWC,'src',9,e,s,gg)
_(oVC,lWC)
_(cUC,oVC)
var aXC=_n('view')
...
_(cUC,aXC)
_(oTC,cUC)
var eZC=_mz(z,'view',['bindtap',12,'class',1,'data-cur',2,'data-event-opts',3],[],e,s,gg)
var b1C=_n('view')
_rz(z,b1C,'class',16,e,s,gg)
var o2C=_n('image')
_rz(z,o2C,'src',17,e,s,gg)
_(b1C,o2C)
_(eZC,b1C)
var x3C=_n('view')
...
_(eZC,x3C)
_(oTC,eZC)
var f5C=_mz(z,'view',['bindtap',20,'class',1,'data-cur',2,'data-event-opts',3],[],e,s,gg)
var c6C=_n('view')
...
_(f5C,o8C)
_(oTC,f5C)
var o0C=_mz(z,'view',['bindtap',28,'class',1,'data-cur',2,'data-event-opts',3],[],e,s,gg)
var lAD=_n('view')
_rz(z,lAD,'class',32,e,s,gg)
var aBD=_n('image')
_rz(z,aBD,'src',33,e,s,gg)
_(lAD,aBD)
_(o0C,lAD)
var tCD=_n('view')
...
var z=gz$gwx_5()
var oFD=_n('view')
var xGD=_mz(z,'scroll-view',['scrollY',-1,'class',0],[],e,s,gg)
var oHD=_mz(z,'image',['class',1,'mode',1,'src',2],[],e,s,gg)
_(xGD,oHD)
var fID=_n('view')
...
var aPD=_mz(z,'navigator',['navigateTo',-1,'class',9,'hoverClass',1,'style',2,'url',3],[],cMD,oLD,gg)
var tQD=_n('view')
_rz(z,tQD,'class',13,cMD,oLD,gg)
var eRD=_oz(z,14,cMD,oLD,gg)
_(tQD,eRD)
_(aPD,tQD)
var bSD=_n('view')
_rz(z,bSD,'class',15,cMD,oLD,gg)
var oTD=_oz(z,16,cMD,oLD,gg)
_(bSD,oTD)
_(aPD,bSD)
var xUD=_n('text')
_rz(z,xUD,'class',17,cMD,oLD,gg)
_(aPD,xUD)
_(oND,aPD)
return oND
}
cJD.wxXCkey=2
_2z(z,7,hKD,e,s,gg,cJD,'item','index','index')
_(xGD,fID)
var oVD=_n('view')
...
var z=gz$gwx_6()
var cXD=_n('view')
var hYD=_mz(z,'scroll-view',['scrollY',-1,'class',0],[],e,s,gg)
var oZD=_mz(z,'image',['class',1,'mode',1,'src',2],[],e,s,gg)
_(hYD,oZD)
var c1D=_n('view')
...
var o8D=_mz(z,'navigator',['navigateTo',-1,'class',9,'hoverClass',1,'style',2,'url',3],[],t5D,a4D,gg)
var x9D=_n('view')
_rz(z,x9D,'class',13,t5D,a4D,gg)
var o0D=_oz(z,14,t5D,a4D,gg)
_(x9D,o0D)
_(o8D,x9D)
var fAE=_n('view')
_rz(z,fAE,'class',15,t5D,a4D,gg)
var cBE=_oz(z,16,t5D,a4D,gg)
_(fAE,cBE)
_(o8D,fAE)
var hCE=_n('text')
_rz(z,hCE,'class',17,t5D,a4D,gg)
_(o8D,hCE)
_(e6D,o8D)
return e6D
}
o2D.wxXCkey=2
_2z(z,7,l3D,e,s,gg,o2D,'item','index','index')
_(hYD,c1D)
var oDE=_n('view')
